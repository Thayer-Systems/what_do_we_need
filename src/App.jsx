...
const isExpired = (e) => e ? e < today() : false;
const isExpiringSoon = (e) => { if(!e) return false; const d=new Date(); d.setDate(d.getDate()+7); return e>=today()&&e<=d.toISOString().split("T")[0]; };
